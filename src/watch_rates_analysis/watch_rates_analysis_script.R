...
clean_watch_events <- raw_watch_events %>% select(-impression_id)
...
write.csv(clean_watch_events, "../../data/output/clean_watch_events.csv", row.names = FALSE)
...
# Save the bar chart into figures
ggsave(
  filename = "../../fig_outputs/action_plot.png",
  plot = action_plot,
  width = 8,
  height = 5,
  dpi = 300
...
ggsave("../../fig_outputs/watch_seconds_plot.png",
...
ggsave(filename = "../../fig_outputs/watch_seconds_per_action_plot.png",
...
#Let's save this chart as well
ggsave("../../fig_outputs/best_creator_plot.png",
