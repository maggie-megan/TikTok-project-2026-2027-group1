...
if (!dir.exists("../../fig_outputs")) {
  dir.create("../../fig_outputs", recursive = TRUE)
}
...
# 5. Save output plot
ggsave("../../fig_outputs/logins_distribution.png", plot = p_logins, width = 7, height = 4.5, dpi = 300)
...
ggsave("../../fig_outputs/content_preferences.png", plot = p_pref, width = 7, height = 4.5, dpi = 300)
...
ggsave("../../fig_outputs/logins_vs_videos.png", plot = p_scatter, width = 7, height = 4.5, dpi = 300)
...
ggsave("../../fig_outputs/interaction_density.png", plot = p_density, width = 7, height = 4.5, dpi = 300)
...
ggsave("../../fig_outputs/satiation_vs_videos.png", plot = p_decay, width = 7, height = 4.5, dpi = 300)
